...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-0 z-30 transform transition-transform duration-300 ease-in-out lg:hidden",
          ...
          <nav className="mt-5 px-2 space-y-1">
            {navigation.map((item) => (
              ...
              >
                <item.icon
                  className={cn(
                    item.href === location.pathname ? 'text-white' : 'text-gray-400 group-hover:text-gray-300',
